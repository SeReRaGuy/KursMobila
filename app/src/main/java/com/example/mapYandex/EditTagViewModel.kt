...
class EditTagViewModel(private val database: TagDatabase, val tagId: Int) : ViewModel() {
    ...
    val commentError: LiveData<String> = _descriptionError
    ...
    private fun getEmptyTag() = Tag(null, "", "", "")
    ...
    companion object {
        fun Factory(cardId: Int): ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(
                ...
                return EditTagViewModel(TagDatabase.getInstance(application), cardId) as T
            }
        }
    }
}